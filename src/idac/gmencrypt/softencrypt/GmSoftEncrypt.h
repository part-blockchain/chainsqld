//------------------------------------------------------------------------------
/*
 This file is part of idacd: https://github.com/chainsql/idacd
 Copyright (c) 2016-2018 Peersafe Technology Co., Ltd.
 
	idacd is free software: you can redistribute it and/or modify
	it under the terms of the GNU General Public License as published by
	the Free Software Foundation, either version 3 of the License, or
	(at your option) any later version.
 
	idacd is distributed in the hope that it will be useful,
...
#include <idac/gmencrypt/hardencrypt/HardEncrypt.h>
#ifdef GM_ALG_PROCESS

//#define SOFTENCRYPT
#ifdef SOFTENCRYPT
#include <idac/gmencrypt/softencrypt/usr/include/openssl/engine.h>
#include <idac/gmencrypt/softencrypt/usr/include/openssl/evp.h>
#include <idac/gmencrypt/softencrypt/usr/include/openssl/rand.h>
#include <idac/gmencrypt/softencrypt/usr/include/openssl/SMEngine.h>
#include <idac/gmencrypt/softencrypt/usr/include/openssl/sm2.h>
