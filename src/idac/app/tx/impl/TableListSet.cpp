...
/*
 ...
 Copyright (c) 2016-2018 IDAC Technology Co., Ltd.
...
#include <idac/app/tx/impl/Tuning.h>
#include <idac/app/tx/OperationRule.h>
            ...
            if (tablesle)  //table exist
            {
                ...
                case T_CREATE:
                {
					...
					// Check reserve and funds availability
					{
						...
						STAmount priorBalance = STAmount((*sleAccount)[sfBalance]).idac();
